...
public class Bootcamp {
    ...
    private Set<Conteudo> cursosEmentorias = new LinkedHashSet<>();
    ...
    public int hashCode() {
        ...
        result = prime * result + ((cursosEmentorias == null) ? 0 : cursosEmentorias.hashCode());
        return result;
    }
    @Override
    public boolean equals(Object obj) {
        ...
        if (devsInscritos == null) {
            ...
            return false;
        if (cursosEmentorias == null) {
            if (other.cursosEmentorias != null)
                return false;
        } else if (!cursosEmentorias.equals(other.cursosEmentorias))
            return false;
        return true;
    }
